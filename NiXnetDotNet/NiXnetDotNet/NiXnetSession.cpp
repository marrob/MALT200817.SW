...
void NiXnetSession::BaudRate64::set(u64 _value)
{
    NiXnet::SetValue<u64>(m_handle, nxPropSession_IntfBaudRate64, _value);
}

u64 NiXnetSession::BaudRate64::get()
{
   return NiXnet::GetValue<u64>(m_handle, nxPropSession_IntfBaudRate64);
}
...
//    f64 Timeout);
void NiXnetSession::WriteFrame(void * buffer, u32 numberOfBytesForFrames, f64 timeout)
{
    NiXnet::CheckStatus(nxWriteFrame(m_handle,buffer, numberOfBytesForFrames, timeout));
}
...
void NiXnetSession::ReadFrame(void* buffer, u32 sizeOfBuffer, f64 timeout, u32 *numberOfBytesReturned)
{
    NiXnet::CheckStatus(nxReadFrame(m_handle, buffer, sizeOfBuffer, timeout, numberOfBytesReturned));
}
