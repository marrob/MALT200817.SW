...
namespace Konvolucio.MUDS150628
{
    ...
    public class AppDfu: IDisposable
    {
        ...
        public void EcuReset(ResetType reset)
        {
            byte[] response;
        ...
        public void DiagSession(Session session)
        {
            byte[] response;
        ...
        public void TesterPresent(byte param)
        {
            byte[] response;
        ...
        public byte RequestDwonLoad(int memorySize )
        {
            byte[] response;
        ...
        public void TransferData(byte blockSequenceCounter, byte[] data)
        {
            if (data.Length > 7)
                if (data.Length > 253)
